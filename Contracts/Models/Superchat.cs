...
/// <summary>
/// Represents a Superchat or Super Sticker event.
/// </summary>
public class Superchat
{
    ...
    /// <summary>
    /// The background color hex code for the Super Chat header. Null for Super Stickers.
    /// </summary>
    public string? HeaderBackgroundColor { get; set; }

    /// <summary>
    /// The text color hex code for the Super Chat header. Null for Super Stickers.
    /// </summary>
    public string? HeaderTextColor { get; set; }

    /// <summary>
    /// The text color hex code for the Super Chat body (user message). Null for Super Stickers.
    /// </summary>
    public string? BodyTextColor { get; set; }

    /// <summary>
    /// The text color hex code for the author's name within the Super Chat or Super Sticker.
    /// </summary>
